    ...
    <main class="p-8">
        <Head title="Privacy Policy" />
            ...
            <ul>
                ...
                <li>
                    <p><strong>Company</strong> (referred to as either "the Company", "We", "Us" or "Our" in this Agreement) refers to Simple Slides.</p>
                </li>
                <li>
                ...
                <li>
                    <p><strong>Website</strong> refers to Simple Slides, accessible from <a href="https://simpleslides.dev" rel="external nofollow noopener" target="_blank">https://simpleslides.dev</a></p>
                </li>
                <li>
            ...
            <ul>
                <li>By email: info@simpleslides.dev</li>
            </ul>
    </main>
</template>
